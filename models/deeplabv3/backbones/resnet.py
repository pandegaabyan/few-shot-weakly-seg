...
def resnext50_32x4d(**kwargs):
    ...
    """
    return ResNet(
        block=Bottleneck, layers=[3, 4, 6, 3], groups=32, width_per_group=4, **kwargs
    )
...
def resnext101_32x8d(**kwargs):
    ...
    """
    return ResNet(
        block=Bottleneck, layers=[3, 4, 23, 3], groups=32, width_per_group=8, **kwargs
    )
...
def wide_resnet50_2(**kwargs):
    ...
    """
    return ResNet(
        block=Bottleneck, layers=[3, 4, 6, 3], width_per_group=64 * 2, **kwargs
    )
...
def wide_resnet101_2(**kwargs):
    ...
    """
    return ResNet(
        block=Bottleneck, layers=[3, 4, 23, 3], width_per_group=64 * 2, **kwargs
    )
