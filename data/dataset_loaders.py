...
def get_meta_loaders(param_list: list[DatasetLoaderParamReduced], data_config: DataConfig,
...
def get_tune_loaders(param: DatasetLoaderParamReduced, data_config: DataConfig,
